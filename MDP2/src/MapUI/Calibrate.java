...
public class Calibrate {
	...
	public static void adjustLeftCorner() {
		try {
			...
			System.out
					.println("I have sent robot to adjust calibration at left corner.");
		} catch (IOException e1) {
			// TODO Auto-generated catch block
			e1.printStackTrace();
			Global.stepwent = 3;
		...
		public static void adjustRightWall() {
			try {
				...
				System.out
						.println("I have sent robot to adjust calibration at rightt wall.");
			} catch (IOException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
				Global.stepwent = 3;
		...
		public static void adjustRightCorner() {
			try {
				...
				System.out
						.println("I have sent robot to adjust calibration at right corner.");
			} catch (IOException e1) {
				// TODO Auto-generated catch block
				e1.printStackTrace();
				Global.stepwent = 3;
